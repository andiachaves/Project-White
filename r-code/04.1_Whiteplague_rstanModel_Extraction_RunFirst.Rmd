...
#NameOfModelRun <- "2018.02.28b_Whiteplague_model_result" # last biological
NameOfModelRun <- "2018.03.01_Whiteplague_model_result" # last environmental
...
predictionsResponseMedianWhitePlague <- inv.logit(as.vector(apply(predictionsLinearWhitePlague, 1, median)))*Whiteplague_workingdata_Annual$Ntot
```
...
file=paste("data/Extraction_diagnosis/",NameOfModelRun,"_graphinput.Rdata",sep=""))
```

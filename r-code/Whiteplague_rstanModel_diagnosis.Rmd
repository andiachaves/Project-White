...
NameOfModelRun <- "2017.08.29c_Whiteplague_model_result_graphinput"
...
```{r}
NameOfModelRun <- "2017.08.29_Whiteplague_model_result"
load(file=paste("data/",NameOfModelRun,".Rdata",sep=""))
...
acf(de, split_pred=list(Subject=Whiteplague_workingdata$Month_12)) #autocorrelation


acf((df), type="p") #partial autocorrelation
```

...
for( i in 1:nWP ) {
RealDisease[i]  = b0  + Environment[i] * parEnvironment + Season[i] * parSeason + parTemperature[i]* Season[i] * parEnvironment* Season + year_raw[Year[i]]* site_raw[Site[i]] + eps[i];

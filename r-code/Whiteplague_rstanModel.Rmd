...
eta4 ~ normal(0, 100);
eta5 ~ normal(0, 100);
sigmalev1 ~ cauchy(0, 1*2.149681);
sigmalev2 ~ cauchy(0, 1*2.149681);
sigmalev3 ~ cauchy(0, 0.75*2.149681);
...
time <- proc.time()
set.seed(2017)
stan.white <- stan(model_code = model.Wplague, data = dataList, iter = 2000, chains = 4,refresh=1, control = list(max_treedepth = 15))

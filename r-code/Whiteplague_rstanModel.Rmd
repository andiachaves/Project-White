...
#Time and location factors (Year, Depth, Month, Season, Station) to use in the model
Year=Whiteplague_working_data$Year
Month=Whiteplague_working_data$Month_number
Season=Whiteplague_working_data$Season
Station=Whiteplague_working_data$Station_name
Depth=Whiteplague_working_data$Depth_disease_transect

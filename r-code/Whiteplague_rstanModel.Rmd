...
stan.test <- stan(model_code = model.Wplague, data = dataList, iter = 1000, chains = 1,refresh=1,thin=1)
```
...
```{r}
save(stan.white, file =paste("data/",today,"_Whiteplague_model_result.Rdata",sep=""))
```

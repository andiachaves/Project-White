...
#enviroselection
Environment= subset(Whiteplague_workingdata, select=c("Depth_tran_sca","Turb_sca"))
...
for (s in 1:nSite) site_raw[s] ~ normal_lpdf(month_raw[Month[s]], tauSite);
for (m in 1:nMonth) month_raw[m] ~ normal_lpdf(0, tauMonth);

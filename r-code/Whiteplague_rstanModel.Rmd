...
## Data preparation
```{r}
df <- Whiteplague_workingdata[,c("Ntot","ill","Plague","Orbicellids", "Sand","Coral", "Sponges","Macroalgae","Cyanobacteria","Chl_sca","Cond_sca","Den_sca", "DepCTD_sca","Oxy_sca","Sal_sca","Turb_sca","Depth_tran_sca","Temp_sca","DHW_sca")]
...
Environment <- df[,c("Orbicellids", "Sand","Coral", "Sponges","Macroalgae", "Cyanobacteria","Chl_sca","Cond_sca","Den_sca", "DepCTD_sca","Oxy_sca","Sal_sca","Turb_sca","Depth_tran_sca","Temp_sca","DHW_sca")]
```
...
```{r}
save(stan.white, file =paste("data/2018.02.12a_Whiteplague_model_result.Rdata",sep=""))
```

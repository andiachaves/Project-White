...
for( i in 1:nWP ) {
RealDisease[i]  = (b0  + Environment[i] * parEnvironment + Season[i] + parSeason * Month[i] + parMonth +eps[i]);
...
```{r}
save(stan.white, file =paste("data/2017.10.09b_Whiteplague_model_result.Rdata",sep=""))
```

...
modelPredictions[,,3], modelPredictions[,,4]) # combining chains
predictionsResponseWPMedian <-inv.logit(as.vector(apply(predictionsLinearWP, 1, median)))*Whiteplague_workingdata$Plague #  WP prevalence and not ill 
```
...
observedResponse = Whiteplague_workingdata$Plague,

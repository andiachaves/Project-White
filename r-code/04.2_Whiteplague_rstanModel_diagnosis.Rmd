...
```{r}
rm(list=ls(all=TRUE))
NameOfModelRun <- "2018.03.07_Whiteplague_Environmental_model_result_graphinput" # last environmental
#NameOfModelRun <- "2018.03.07_Whiteplague_Biological_model_result_graphinput" # last biological

...
E1 <- glmer(cbind(Ntot,ill) ~ Depth + Turbidity + (1|Month/Site),family="binomial"(link = "logit"))
summary(E1)

#two random effects one temporal month nested within season and one spatial site nested within depth
E2 <- glmer(cbind(Ntot,ill) ~ Depth + Turbidity + (1|Season/Month) + (1|Depth/Site) ,family="binomial"(link = "logit"))
summary(E2)

#Month nested within site. Intercept varying among sites and months within sites
E3 <- glmer(cbind(Ntot,ill) ~ Depth + Turbidity + (1|Site/Month) ,family="binomial"(link = "logit"))
summary(E3)

#combination of effect of mont and site nested within season
E4 <- glmer(cbind(Ntot,ill) ~ Depth + Turbidity + (1|Season/Month:Site) ,family="binomial"(link = "logit"))
summary(E4)

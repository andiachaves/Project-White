...
G1 <- glmer2stan(cbind(ill,healthy) ~ Depth + Turbidity + (1+ Season_index|Month_index) + (1|Site_index),data=df,family="binomial")

G1 <- glmer2stan(cbind(ill,healthy) ~ Depth + Turbidity + (1|Site_index/Month) + (1|Month_index),data=df,family="binomial")

...
## Data preparation
```{r}
df <- Whiteplague_workingdata[,c("Ntot","ill","Plague","Chl_sca","Oxy_sca","Sal_sca","Turb_sca","Depth","Temp_sca","DHW_sca")]
...
```{r}
save(stan.white, file =paste("results/2018.03.07_Whiteplague_Environmental_model_result.Rdata",sep=""))
```

...
> White$Month<-factor(White$Month) #Convert Month into a labelled factor to use as a grouping variabel
> p5 <- ggplot(White, aes(x = Month, y = Rainfall)) +
+ geom_boxplot()
> p5
> White$Month<-factor(White$Month) #Convert Month into a labelled factor to use as a grouping variabel
> p5 <- ggplot(White, aes(x = Month, y = Salinity)) +
+ geom_boxplot()
> p5
> White$Month<-factor(White$Month) #Convert Month into a labelled factor to use as a grouping variabel
> p7 <- ggplot(White, aes(x = Month, y = Temperature)) +
+         geom_boxplot()
> p7
> White$Month<-factor(White$Month) #Convert Month into a labelled factor to use as a grouping variabel
> p8 <- ggplot(White, aes(x = Month, y = Turbidity)) +
+ geom_boxplot()
> p8
> White$Month<-factor(White$Month) #Convert Month into a labelled factor to use as a grouping variabel
> p9 <- ggplot(White, aes(x = Month, y = White_Plague_Prevalence)) +
+         geom_boxplot()
> p9
Error in eval(expr, envir, enclos) : 
  object 'White_Plague_Prevalence' not found
> White$Month<-factor(White$Month) #Convert Month into a labelled factor to use as a grouping variabel
> p9 <- ggplot(White, aes(x = Month, y = White_Plague_Pervalence)) +
+         geom_boxplot()
> p9
> White$Month<-factor(White$Month) #Convert Month into a labelled factor to use as a grouping variabel
> p9 <- ggplot(White, aes(x = Month, y = X.coral)) +
+         geom_boxplot()
> p9
Error in eval(expr, envir, enclos) : object 'X.coral' not found
> White$Month<-factor(White$Month) #Convert Month into a labelled factor to use as a grouping variabel
> p9 <- ggplot(White, aes(x = Month, y = X.Coral)) +
+         geom_boxplot()
> p9

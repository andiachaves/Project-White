...
load('~/Documents/Project-White/Data/Whiteplague-rawdata.rdata', envir = white.env)
ls()
#check data
ls(White)
dim(White)
...
enviroselection = c(32:34) # to select all 11 environmental variables. ``{r}

#Save working data  file with data already scaled/ and or transformed to be used by the model
save(White,file="data/Whiteplague-workingdata.rdata")
ls()
#check data
ls(White)
dim(White)

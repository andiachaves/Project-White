...
Environment <- df[,c("Chl_sca","Chl_sca2","Oxy_sca","Oxy_sca2","Sal_sca","Sal_sca2","Turb_sca","Turb_sca2","Temp_sca","Temp_sca2", "DHW_sca","DHW_sca2","Sand","Coral","Sponges","Macroalgae", "Cyanobacteria")]


#Environment <- df[,c("Chl_sca","Chl_sca2","Oxy_sca","Oxy_sca2","Sal_sca","Sal_sca2","Turb_sca","Temp_sca","Temp_sca2", "DHW_sca","DHW_sca2","Sand","Coral","Sponges","Macroalgae", "Cyanobacteria")]
...
```{r}
save(stan.white, file =paste("results/2018.03.7_Whiteplague_Biological_model_result.Rdata",sep=""))
```

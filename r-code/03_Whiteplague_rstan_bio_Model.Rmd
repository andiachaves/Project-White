...
## Data preparation
```{r}
df <- data.frame(Whiteplague_workingdata_Annual[,c("Station_code","Year","Season","Depth_tran_sca", "Ntot","ill","Plague","Chl_sca","Oxy_sca","Sal_sca","Turb_sca","Temp_sca","DHW_sca", "Sand", "Coral", "Sponges","Macroalgae", "Cyanobacteria")])
...
Environment <- df[,c("Chl_sca","Chl_sca2","Oxy_sca","Oxy_sca2","Sal_sca","Sal_sca2","Turb_sca","Turb_sca2","Temp_sca","Temp_sca2", "DHW_sca","DHW_sca2","Depth_tran_sca","Depth_tran_sca2","Sand","Coral","Sponges","Macroalgae", "Cyanobacteria")]
...
plot(stan.white,pars=c(printVarEnvironment))
...
```{r}
save(stan.white, file =paste("results/2018.03.8_Whiteplague_Biological_model_result.Rdata",sep=""))
```

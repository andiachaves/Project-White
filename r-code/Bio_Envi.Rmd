...
dataList = list (
        ...
        Temperature = White$TempScaled,
        Chlorophyll = White$ChlScaled,
        Salinity = White$SalScaled,
        Turbidity = White$TurScaled,
        Environment = White[12:(12-1+length(enviroselection))],
